...
#         self.assertEqual(response.data['email'], 'Sefarz@example.com')
...
#         User.objects.create_user(email='Sefarz@example.com', password='testpassword', name="Test User")

#         url = reverse('register') 

#         data = {
#             'email': 'Sefarz@example.com',  # Duplicate email
#             'name': 'Test User',
#             'password': 'testpassword',
#             'confirm_password': 'testpassword'
#         }
...
#         user = User.objects.create(email='Sefarz@example.com', is_active=False)
...
#         user = User.objects.create(email='Sefarz@example.com', is_active=True)
#         token = default_token_generator.make_token(user)
#         uid = urlsafe_base64_encode(force_bytes(user.pk))
...
#     def setUp(self):
#         self.user = User.objects.create_user(email='Sefarz@example.com', password='testpassword', name='Test User')
